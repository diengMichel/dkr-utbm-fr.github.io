...
<!-- sidebar starts -->
        <a href="./oui.php?id=<?php echo $userID ?>"><div class="sidebarRow">
          <img
            class="user__avatar"
        ...
        <a href="./userPage.php?id=<?php echo $userID ?>"><div class="sidebarRow">
          <span class="material-symbols-outlined"> home </span>
          <h4>My Page</h4>
        </div>
        </a>

        <a href="./lastPostPage.php?id=<?php echo $userID ?>"><div class="sidebarRow">
          <span class="material-symbols-outlined"> Explore </span>
          <h4>Explore</h4>
        </div>
        </a>

        <a href="./mostLikedPostPage.php?id=<?php echo $userID ?>"><div class="sidebarRow">
          <span class="material-symbols-outlined"> star </span>
          <h4>Trend</h4>
        </div>
        </a>

        <a href="./follows_page.php?id=<?php echo $userID ?>" ><div class="sidebarRow">
        ...
        <a href="./statisticPage.php?id=<?php echo $userID ?>" ><div class="sidebarRow">
          <span class="material-symbols-outlined"> equalizer </span>
          <h4>Your Statistics</h4>
        </div>
        </a>

        <a href="./account_infos.php?id=<?php echo $userID ?>" ><div class="sidebarRow">
